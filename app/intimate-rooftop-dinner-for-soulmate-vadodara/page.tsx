...
const keyword = getKeywordBySlug('rooftop-experience', 'intimate-rooftop-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-rooftop-dinner-for-soulmate-vadodara',
  },
};
