...
const keyword = getKeywordBySlug('rooftop-experience', 'november-rooftop-date-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/november-rooftop-date-for-better-half-vadodara',
  },
};
