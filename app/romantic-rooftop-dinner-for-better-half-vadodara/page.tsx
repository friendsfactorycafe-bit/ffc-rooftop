...
const keyword = getKeywordBySlug('rooftop-experience', 'romantic-rooftop-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-rooftop-dinner-for-better-half-vadodara',
  },
};
