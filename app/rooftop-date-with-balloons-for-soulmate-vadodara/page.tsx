...
const keyword = getKeywordBySlug('rooftop-experience', 'rooftop-date-with-balloons-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/rooftop-date-with-balloons-for-soulmate-vadodara',
  },
};
