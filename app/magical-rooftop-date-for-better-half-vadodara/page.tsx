...
const keyword = getKeywordBySlug('rooftop-experience', 'magical-rooftop-date-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/magical-rooftop-date-for-better-half-vadodara',
  },
};
