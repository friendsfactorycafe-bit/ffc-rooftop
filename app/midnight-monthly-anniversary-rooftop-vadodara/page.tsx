...
const keyword = getKeywordBySlug('rooftop-experience', 'midnight-monthly-anniversary-rooftop-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/midnight-monthly-anniversary-rooftop-vadodara',
  },
};
