...
const keyword = getKeywordBySlug('rooftop-experience', 'september-rooftop-dinner-for-partner-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/september-rooftop-dinner-for-partner-vadodara',
  },
};
