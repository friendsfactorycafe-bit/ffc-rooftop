...
const keyword = getKeywordBySlug('rooftop-experience', 'january-rooftop-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/january-rooftop-dinner-for-boyfriend-vadodara',
  },
};
