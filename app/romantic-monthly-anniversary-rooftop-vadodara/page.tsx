...
const keyword = getKeywordBySlug('rooftop-experience', 'romantic-monthly-anniversary-rooftop-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-monthly-anniversary-rooftop-vadodara',
  },
};
