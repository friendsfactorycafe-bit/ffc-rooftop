...
const keyword = getKeywordBySlug('rooftop-experience', 'february-rooftop-date-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/february-rooftop-date-for-girlfriend-vadodara',
  },
};
