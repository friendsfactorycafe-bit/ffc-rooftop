...
const keyword = getKeywordBySlug('rooftop-experience', 'intimate-rooftop-date-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-rooftop-date-for-better-half-vadodara',
  },
};
