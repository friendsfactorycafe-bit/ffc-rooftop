...
const keyword = getKeywordBySlug('rooftop-experience', 'rooftop-date-with-fireworks-for-fiancee-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/rooftop-date-with-fireworks-for-fiancee-vadodara',
  },
};
