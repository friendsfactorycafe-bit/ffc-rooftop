...
const keyword = getKeywordBySlug('rooftop-experience', 'magical-rooftop-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/magical-rooftop-dinner-for-better-half-vadodara',
  },
};
