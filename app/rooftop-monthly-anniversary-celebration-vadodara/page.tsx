...
const keyword = getKeywordBySlug('rooftop-experience', 'rooftop-monthly-anniversary-celebration-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/rooftop-monthly-anniversary-celebration-vadodara',
  },
};
