...
const keyword = getKeywordBySlug('rooftop-experience', 'special-rooftop-date-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/special-rooftop-date-for-better-half-vadodara',
  },
};
