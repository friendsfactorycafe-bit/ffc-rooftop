...
const keyword = getKeywordBySlug('rooftop-experience', 'rooftop-date-with-candlelight-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/rooftop-date-with-candlelight-for-better-half-vadodara',
  },
};
