...
const keyword = getKeywordBySlug('rooftop-experience', 'rooftop-dinner-with-personalised-message-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/rooftop-dinner-with-personalised-message-vadodara',
  },
};
