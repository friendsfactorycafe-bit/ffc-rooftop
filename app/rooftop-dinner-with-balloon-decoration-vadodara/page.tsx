...
const keyword = getKeywordBySlug('rooftop-experience', 'rooftop-dinner-with-balloon-decoration-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/rooftop-dinner-with-balloon-decoration-vadodara',
  },
};
