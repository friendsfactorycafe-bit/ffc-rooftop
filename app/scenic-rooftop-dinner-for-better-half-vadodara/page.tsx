...
const keyword = getKeywordBySlug('rooftop-experience', 'scenic-rooftop-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/scenic-rooftop-dinner-for-better-half-vadodara',
  },
};
