...
const keyword = getKeywordBySlug('rooftop-experience', 'sunset-rooftop-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/sunset-rooftop-dinner-for-better-half-vadodara',
  },
};
