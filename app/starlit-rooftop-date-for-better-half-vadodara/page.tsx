...
const keyword = getKeywordBySlug('rooftop-experience', 'starlit-rooftop-date-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/starlit-rooftop-date-for-better-half-vadodara',
  },
};
