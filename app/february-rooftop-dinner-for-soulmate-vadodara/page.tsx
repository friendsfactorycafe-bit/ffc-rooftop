...
const keyword = getKeywordBySlug('rooftop-experience', 'february-rooftop-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/february-rooftop-dinner-for-soulmate-vadodara',
  },
};
