...
const keyword = getKeywordBySlug('rooftop-experience', 'april-rooftop-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/april-rooftop-dinner-for-better-half-vadodara',
  },
};
