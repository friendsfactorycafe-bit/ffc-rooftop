...
const keyword = getKeywordBySlug('rooftop-experience', 'august-rooftop-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/august-rooftop-dinner-for-better-half-vadodara',
  },
};
