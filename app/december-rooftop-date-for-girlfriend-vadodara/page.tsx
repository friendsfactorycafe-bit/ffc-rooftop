...
const keyword = getKeywordBySlug('rooftop-experience', 'december-rooftop-date-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/december-rooftop-date-for-girlfriend-vadodara',
  },
};
