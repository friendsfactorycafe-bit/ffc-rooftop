...
const keyword = getKeywordBySlug('rooftop-experience', 'special-rooftop-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/special-rooftop-dinner-for-boyfriend-vadodara',
  },
};
