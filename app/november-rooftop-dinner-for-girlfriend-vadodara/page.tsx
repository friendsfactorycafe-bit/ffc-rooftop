...
const keyword = getKeywordBySlug('rooftop-experience', 'november-rooftop-dinner-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/november-rooftop-dinner-for-girlfriend-vadodara',
  },
};
