...
const keyword = getKeywordBySlug('rooftop-experience', 'october-rooftop-date-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/october-rooftop-date-for-better-half-vadodara',
  },
};
