...
const keyword = getKeywordBySlug('rooftop-experience', 'outdoor-rooftop-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/outdoor-rooftop-dinner-for-better-half-vadodara',
  },
};
