...
const keyword = getKeywordBySlug('rooftop-experience', 'midnight-rooftop-date-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/midnight-rooftop-date-for-better-half-vadodara',
  },
};
