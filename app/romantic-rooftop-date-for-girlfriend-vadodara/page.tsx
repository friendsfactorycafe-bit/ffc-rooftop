...
const keyword = getKeywordBySlug('rooftop-experience', 'romantic-rooftop-date-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-rooftop-date-for-girlfriend-vadodara',
  },
};
