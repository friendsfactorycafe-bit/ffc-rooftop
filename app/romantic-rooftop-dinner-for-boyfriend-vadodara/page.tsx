...
const keyword = getKeywordBySlug('rooftop-experience', 'romantic-rooftop-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/romantic-rooftop-dinner-for-boyfriend-vadodara',
  },
};
