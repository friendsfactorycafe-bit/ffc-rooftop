...
const keyword = getKeywordBySlug('rooftop-experience', 'private-rooftop-dinner-for-boyfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/private-rooftop-dinner-for-boyfriend-vadodara',
  },
};
