...
const keyword = getKeywordBySlug('rooftop-experience', 'october-rooftop-dinner-for-better-half-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/october-rooftop-dinner-for-better-half-vadodara',
  },
};
