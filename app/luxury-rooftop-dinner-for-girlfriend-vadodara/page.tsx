...
const keyword = getKeywordBySlug('rooftop-experience', 'luxury-rooftop-dinner-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/luxury-rooftop-dinner-for-girlfriend-vadodara',
  },
};
