...
const keyword = getKeywordBySlug('rooftop-experience', 'starlit-rooftop-dinner-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/starlit-rooftop-dinner-for-girlfriend-vadodara',
  },
};
