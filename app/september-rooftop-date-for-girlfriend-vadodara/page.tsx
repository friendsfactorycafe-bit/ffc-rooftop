...
const keyword = getKeywordBySlug('rooftop-experience', 'september-rooftop-date-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/september-rooftop-date-for-girlfriend-vadodara',
  },
};
