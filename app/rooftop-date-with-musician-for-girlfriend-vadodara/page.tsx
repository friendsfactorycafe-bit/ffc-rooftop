...
const keyword = getKeywordBySlug('rooftop-experience', 'rooftop-date-with-musician-for-girlfriend-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/rooftop-date-with-musician-for-girlfriend-vadodara',
  },
};
