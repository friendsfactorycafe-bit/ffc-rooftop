...
const keyword = getKeywordBySlug('rooftop-experience', 'midnight-rooftop-dinner-for-soulmate-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/midnight-rooftop-dinner-for-soulmate-vadodara',
  },
};
