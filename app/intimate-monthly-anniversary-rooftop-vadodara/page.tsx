...
const keyword = getKeywordBySlug('rooftop-experience', 'intimate-monthly-anniversary-rooftop-vadodara');

export const metadata: Metadata = {
  title: keyword?.metaTitle || 'Friends Factory Cafe',
  description: keyword?.metaDescription || '',
  alternates: {
    canonical: '/intimate-monthly-anniversary-rooftop-vadodara',
  },
};
